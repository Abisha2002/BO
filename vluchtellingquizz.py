...
#vragen 
def vraag18(): #Richting de einde waar bij controle door de politie een mes word gevonden.
    print("f")
...
def vraag10():
    ...
    if antwood10.lower == "a":
        ...
        print(vraag18()) # Richting de einde waar bij controle door de politie een mes word gevonden.
...
def vraag7():
    ...
    if antwoord.lower == "a":
        ...
        time.sleep(1)
        vraag16() #je krijgt honger op de boot wat doe je?
